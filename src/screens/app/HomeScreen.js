        ...
        <SafeAreaView style = {(isWeb ? {height: '100dvh'}: {height: '100%'})} >
          ...
          <Portal>
            <FAB.Group
              ...
              actions={[
                {
                  ...
                  // Evita estilos complejos aquí si estás en Web
              ...
              // Ajusta el fabStyle para que no colisione
              fabStyle={{ 
                backgroundColor: open ? AppColors.placeholder : AppColors.primary,
                bottom: isWeb ? 20 : 100 // Ajuste para web
              }}
              color={AppColors.background}
            />
          </Portal>
