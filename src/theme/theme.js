...
const AppColors = {
  ...
  background: '#F8F9FA',  // Off-white para evitar el brillo excesivo
  surface: '#FFFFFF',
...
export const globalStyles = StyleSheet.create({
  ...
  card: { 
    ...
    elevation: 2, // Elevación sutil para no distraer
    borderRadius: 16, 
    padding: 16,
  },
  header: { 
  ...
  input: { 
    marginBottom: 20, // Más separación entre inputs para evitar errores
    backgroundColor: AppColors.surface 
  },
  button: { 
    marginTop: 10, 
  ...
  link: {
    alignSelf: "center",
    marginTop: 20,
    padding: 10 // Área de toque más grande (Fitts's Law)
  },
  linkText: {
    color: AppColors.primary,
    fontWeight: "600",
    textDecorationLine: 'underline' // Indica claramente que es un link
  },
  fab: { backgroundColor: AppColors.primary, position: 'absolute', margin: 16, right: 0, bottom: 0 },
